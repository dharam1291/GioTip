...
var lat,lng;
var cityCircle;
function initializeMap(citylat,citylng,address){
	  var position = new google.maps.LatLng(citylat, citylng)
...
function showmarkPoint(address){
